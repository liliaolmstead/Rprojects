...
sampletype <- factor(c(rep("Activated_CD4",3), rep("Naive_CD4", 3)))
...
ggplot(data) +
  geom_histogram(aes(x = Activated_CD4_Rep1), stat = "bin", bins = 200) +
...
write.table(d, file="results/SCRIB1_CD4_counts.txt", sep="\t", quote=F, col.names=NA)
...
write.table(d, file="results/SCRIB2_CD4_counts.txt", sep="\t", quote=F, col.names=NA)
...
write.table(d, file="results/LLGL1_CD4_counts.txt", sep="\t", quote=F, col.names=NA)
...
write.table(d, file="results/LLGL2_CD4_counts.txt", sep="\t", quote=F, col.names=NA)
...
write.table(d, file="results/PARD6A_CD4_counts.txt", sep="\t", quote=F, col.names=NA)
...
write.table(d, file="results/PARD6B_CD4_counts.txt", sep="\t", quote=F, col.names=NA)
...
write.table(d, file="results/PARD3_CD4_counts.txt", sep="\t", quote=F, col.names=NA)
...
write.table(d, file="results/DLG1_CD4_counts.txt", sep="\t", quote=F, col.names=NA)

# Plot the DLG1 normalized counts, using the samplenames (rownames(d) as labels) 
ggplot(d, aes(x = sampletype, y = count, color = sampletype)) + 
  geom_point(position=position_jitter(w = 0.1,h = 0)) +
  geom_text_repel(aes(label = rownames(d))) +
  theme_bw() +
...
write.table(d, file="results/DLG2_CD4_counts.txt", sep="\t", quote=F, col.names=NA)
...
write.table(d, file="results/DLG3_CD4_counts.txt", sep="\t", quote=F, col.names=NA)
...
write.table(d, file="results/DLG4_CD4_counts.txt", sep="\t", quote=F, col.names=NA)
...
write.table(d, file="results/DLG5_CD4_counts.txt", sep="\t", quote=F, col.names=NA)

# Plot the DLG5 normalized counts, using the samplenames (rownames(d) as labels) 
ggplot(d, aes(x = sampletype, y = count, color = sampletype)) + 
  geom_point(position=position_jitter(w = 0.1,h = 0)) +
  geom_text_repel(aes(label = rownames(d))) +
  theme_bw() +
...
contrast_Activated_CD4 <- c("sampletype", "Activated_CD4", "Naive_CD4")
